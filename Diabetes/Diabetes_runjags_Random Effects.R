...
jags.m <- run.jags(model="Diabetes_Random.txt", monitor=c("d[2]", "d[3]",  "d[4]", "d[5]", "d[6]", "T[1]", "T[2]", "T[3]", "T[4]", "T[5]", "T[6]",  "sd" ,  "totresdev", "deviance", "pd", "dic" , "full.pd"  ),
...
#jags.m <- autorun.jags(model="Diabetes_Random.txt", monitor=c("d[2]", "d[3]",  "d[4]", "d[5]", "d[6]", "T[1]", "T[2]", "T[3]", "T[4]", "T[5]", "T[6]",  "sd" ,  "totresdev", "deviance", "pd", "dic" , "full.pd"  ),
#                   data=list("ns"=ns, "nt"=nt, "na"=na, "r"=r, "time"=time, "t"=t, "n"=n) , n.chains=3, inits=all.inits, burnin = 100000, sample = 100000, adapt = 5000, max.time="1hr")
