...
set.seed(3)
Data_toxin <- rnorm(12, mean = 4000, sd = 100)
#Data_toxin
Data_toxin[1:3] <- Data_toxin[1:3]/(1*1.5)
Data_toxin[4:6] <- Data_toxin[4:6]/(10*1.5)
Data_toxin[7:9] <- Data_toxin[7:9]/(100*1.5)
Data_toxin[10:12] <- Data_toxin[10:12]/(1000*1.5)
#Data_toxin
...
data = as.matrix(read.table("DatenMOC.txt", sep = "", header=F))
