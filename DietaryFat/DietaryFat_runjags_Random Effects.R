########## ########## Simulation Dietary Fat Beispiel mit Random Effects mit dem runjags package
...
jags.m <- run.jags(model="DietaryFat_Random.txt", monitor=c("d[2]", "T[1]", "T[2]", "sd" ,  "totresdev", "deviance", "pd", "dic" , "full.pd"  ),
                   data=list("ns"=ns, "nt"=nt, "na"=na, "r"=r, "E"=E, "t"=t) , n.chains=3, inits=all.inits, burnin = 100000, sample = 100000, adapt = 5000)
