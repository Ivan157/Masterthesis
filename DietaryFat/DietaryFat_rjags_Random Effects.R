########## ########## Simulation Dietary Fat Beispiel mit Random Effects mit dem rjags package
...
##### Initialization
update(jags.m, 100000) # burn in 



##### run JAGS and save posterior samples
samps_coda <- coda.samples( jags.m, variable.names=c("d[2]", "T[1]", "T[2]", "sd"),   n.iter=100000, DIC=T  ) 
...
summary(window(samps_coda, start=100001)) # burnin = 100000
