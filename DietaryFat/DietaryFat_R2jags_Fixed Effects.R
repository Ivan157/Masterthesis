########## ########## Simulation Dietary Fat Beispiel mit Fixed Effects mit dem R2jags package
...
jags.m <- jags(data=dat,  inits=all.inits, parameters.to.save=params,  n.chains = 3, n.iter = 21000, n.burnin = 9000,
               model.file="DietaryFat_Fixed.txt", DIC=TRUE,  jags.module = c("glm","dic") )  
