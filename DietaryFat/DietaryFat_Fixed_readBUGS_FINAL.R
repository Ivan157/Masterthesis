...
readBUGS_Model <- readBUGSmodel(model='DietaryFat_Fixed_Model_Nimble.bug', data = 'DietaryFat_Data_Nimble.R',
                                inits = 'DietaryFat_Inits_Fixed_Nimble.R' )  
...
Hilf_data = read.table("Hilf4.txt", sep = "", header=F, skip=2)
#Hilf_data
