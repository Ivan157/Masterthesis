########## ########## Simulation Blocker Beispiel mit Fixed Effects mit dem R2jags package
...
jags.m <- jags(data=dat,  inits=all.inits, parameters.to.save=params,  n.chains = 3, n.iter = 30000, n.burnin = 10000,
               model.file="Blocker_Fixed.txt", DIC=TRUE,  jags.module = c("glm","dic") )  
...
# Berechnung Daten für leverage plot und manuelle Berechnung von pD --------------------------------------
