########## ########## Simulation Blocker Beispiel mit Fixed Effects mit dem runjags package
...
jags.m <- run.jags(model="Blocker_Fixed.txt", monitor=c("d[2]", "T[1]", "T[2]",  "totresdev", "deviance", "pd", "dic" , "full.pd"  ),
...
#jags.m <- autorun.jags(model="Blocker_Fixed.txt", monitor=c("d[2]", "T[1]", "T[2]",  "totresdev", "deviance", "pd", "dic" , "full.pd"  ),
...
jags.m_levPlot <- run.jags(model="Blocker_Fixed.txt", monitor=c("dev", "rhat"), 
