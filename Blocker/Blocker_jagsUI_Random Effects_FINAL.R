########## ########## Simulation Blocker Beispiel mit Random Effects mit dem jagsUI package
...
setwd("C:/Users/IvanB/Desktop/Masterarbeit/Statistische Programme und Gibbs Sampler/Programm JAGS/Nachrechnen TSD2-Dokument/Nachrechnen mit jagsUI/Ex1 Blocker")
