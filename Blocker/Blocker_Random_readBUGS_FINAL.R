...
readBUGS_Model <- readBUGSmodel(model='Blocker_Random_Model_Nimble_II.bug', data = 'Blocker_Data_Nimble.R',
                               inits = 'Blocker_Inits_Nimble_II.R' )  
...
cat("Hilf_lePlo", out_lePlo, file="Hilf3.txt", sep="\n", append=TRUE)


Hilf_data = read.table("Hilf3.txt", sep = "", header=F, skip=298, nrows=88)
#Hilf_data
